...
<html dir="ltr">
    ...
    <body class="visualisation-body">
        ...
        <?php session_start(); $_SESSION["categorie"] = "Méthanisation"; ?>
        <?php include 'config.php'; ?>
		<?php include 'methanisation.md.php'; ?>
		<?php // include 'methanisation.md.contact.php'; ?>
        <?php include 'nav.php'; ?>
        ...
        <!-- Main App -->
        <script src="methanisation.js"></script>
