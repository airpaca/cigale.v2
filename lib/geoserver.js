		...
		$.ajax({
			...
			success: function(response,textStatus,jqXHR){
                ...
                if ( (jqXHR.style_dict != false) && (typeof jqXHR.style_dict.jenks != "undefined") ) {
                    jqXHR.style_dict.jenks_calcules = calc_jenks(response, jqXHR.style_dict.jenks.field, jqXHR.style_dict.jenks.njenks, jqXHR.style_dict.jenks.colorscale);
                };
