...
/* 		// Si bouton
    ...
    if ( (typeof dict_args != "undefined") && (typeof dict_args.graphique != "undefined") ) {
        ...
        console.log(dict_args.graphique);
        ...
        switch(dict_args.graphique.type) {
            case "header":
                ...
                break;
            case "bar":
                $("#"+this.name).append("BAR</br>CHART");
                break;
            case "pie":
                $("#"+this.name).append("PIE</br>CHART");
                break;
            case "line":
                $("#"+this.name).append("LINE</br>CHART");                
                break;
            default:
                console.log("ERRRO: Type de graphique non pris en compte");
                break;
        };
