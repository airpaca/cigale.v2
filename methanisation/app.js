...
app = {
    ...
    blocks: {
        ...
        select_zones: new Select("select-zones", "#left-select", "api.php/liste_territoires.php", "Entrez les premières lettres d'un EPCI, commune, Parc Naturel, ...", "zoom_territoire", "Je recherche un territoire"),
